...
namespace WebApplication
     ...
     public class BundleConfig
          ...
          public static void RegisterBundles(BundleCollection bundles)
               ...
               RegisterWynScripts(bundles);
               }

          private static void RegisterWynScripts(BundleCollection bundles)
               {
               bundles.Add(new ScriptBundle("~/Scripts/WynPower/Bom")
                    .Include("~/Scripts/WynPower/BOMScript.js"));

               bundles.Add(new ScriptBundle("~/Scripts/WynPower/Assembly")
                   .Include("~/Scripts/WynPower/AssemblyScript.js"));

               bundles.Add(new ScriptBundle("~/Scripts/WynPower/Material")
                   .Include("~/Scripts/WynPower/Material.js"));
               }
          ...
          private static void RegisterHome(BundleCollection bundles)
               ...
               bundles.Add(new StyleBundle("~/AdminLTE/3rdParty/tabelizer").Include(
                    "~/AdminLTE/3rdParty/tabelizer.min.css"));
               ...
               bundles.Add(new ScriptBundle("~/AdminLTE/3rdParty/tabelizer")
                    .Include("~/AdminLTE/3rdParty/jquery.tabelizer.min.js"));
               }
